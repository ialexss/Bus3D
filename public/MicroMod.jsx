...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[2.795, 3.674, -2.898]} rotation={[Math.PI / 2, 0, -0.008]}>
      ...
      <mesh geometry={nodes.AroD1.geometry} material={materials['Material.007']} position={[2.445, 1.075, -7.094]} rotation={[Math.PI / 2, 0, 0]} />
      ...
      <mesh geometry={nodes.Volante.geometry} material={materials.volante} position={[-1.628, 4.215, -8.024]} rotation={[Math.PI / 2, 0, 0]} />
      ...
      <mesh geometry={nodes.LlantaD2.geometry} material={materials['Llantas.001']} position={[2.331, 1.082, 5.165]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.LlantaD1.geometry} material={materials['Llantas.003']} position={[2.326, 1.079, -7.088]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.LlantaI1.geometry} material={materials['Llantas.005']} position={[-2.135, 1.076, 5.183]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.LlantaI2.geometry} material={materials['Llantas.006']} position={[-2.126, 1.084, -7.076]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.AroI1.geometry} material={materials['Material.002']} position={[-2.258, 1.081, -7.078]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.AroD2.geometry} material={materials['Material.004']} position={[2.355, 1.086, 5.175]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={nodes.AroI2.geometry} material={materials['Material.005']} position={[-2.087, 1.082, 5.181]} rotation={[Math.PI / 2, 0, 0]} />
      <group position={[2.811, 3.701, -5.417]} rotation={[Math.PI / 2, 0, 0]}>
        <mesh geometry={nodes.mesh_0_20nr004.geometry} material={materials['exterior.002']} />
        <mesh geometry={nodes.mesh_0_20nr004_1.geometry} material={materials['exteriorbajo.001']} />
      </group>
